...
VALUES (
  ...
  '{"preview":true,"dna_version":"2.5.2","node_type":"LLM","sub_phase":"A_design","group":"A1","depends_on":[],"parallel_with":[],"status":"mandatory_in_full_preprod | mandatory_in_ideation_factory","amendments":["real_files","game_derived_skin","two_pass_qa","structure_not_skin","design_bar","examples_as_illustration"]}'::jsonb
)
...
VALUES (
  ...
  '{"preview":true,"dna_version":"2.5.2","node_type":"LLM","sub_phase":"A_design","group":"A1","depends_on":["3.1"],"parallel_with":[],"status":"mandatory_in_full_preprod | mandatory_in_ideation_factory","amendments":["real_files","game_derived_skin","two_pass_qa","structure_not_skin","design_bar","examples_as_illustration"]}'::jsonb
)
ON CONFLICT (node_key) DO UPDATE SET
  title=EXCLUDED.title, phase=EXCLUDED.phase, role=EXCLUDED.role, status=EXCLUDED.status,
  purpose=EXCLUDED.purpose, standalone_prompt=EXCLUDED.standalone_prompt, default_prompt=EXCLUDED.default_prompt,
...
VALUES (
  ...
  '{"preview":true,"dna_version":"2.5.2","node_type":"LLM","sub_phase":"A_design","group":"A2","depends_on":["3.2"],"parallel_with":["3.4"],"status":"mandatory_in_full_preprod | optional_in_ideation_factory","amendments":["real_files","game_derived_skin","two_pass_qa","structure_not_skin","design_bar","examples_as_illustration"]}'::jsonb
)
ON CONFLICT (node_key) DO UPDATE SET
  title=EXCLUDED.title, phase=EXCLUDED.phase, role=EXCLUDED.role, status=EXCLUDED.status,
  purpose=EXCLUDED.purpose, standalone_prompt=EXCLUDED.standalone_prompt, default_prompt=EXCLUDED.default_prompt,
...
VALUES (
  ...
  '{"preview":true,"dna_version":"2.5.2","node_type":"LLM","sub_phase":"A_design","group":"A2","depends_on":["3.1","3.2"],"parallel_with":["3.3"],"status":"mandatory_in_full_preprod | removable_in_ideation_factory","amendments":["real_files","game_derived_skin","two_pass_qa","structure_not_skin","design_bar","examples_as_illustration"]}'::jsonb
)
ON CONFLICT (node_key) DO UPDATE SET
  title=EXCLUDED.title, phase=EXCLUDED.phase, role=EXCLUDED.role, status=EXCLUDED.status,
  purpose=EXCLUDED.purpose, standalone_prompt=EXCLUDED.standalone_prompt, default_prompt=EXCLUDED.default_prompt,
...
VALUES (
  ...
  '{"preview":true,"dna_version":"2.5.2","node_type":"LLM","sub_phase":"A_design","group":"A2b","depends_on":["3.4","3.2"],"parallel_with":["3.5"],"status":"mandatory_in_full_preprod | removable_in_ideation_factory","amendments":["real_files","game_derived_skin","two_pass_qa","structure_not_skin","design_bar","examples_as_illustration"]}'::jsonb
)
ON CONFLICT (node_key) DO UPDATE SET
  title=EXCLUDED.title, phase=EXCLUDED.phase, role=EXCLUDED.role, status=EXCLUDED.status,
  purpose=EXCLUDED.purpose, standalone_prompt=EXCLUDED.standalone_prompt, default_prompt=EXCLUDED.default_prompt,
...
VALUES (
  ...
  '{"preview":true,"dna_version":"2.5.2","node_type":"LLM","sub_phase":"A_design","group":"A2b","depends_on":["3.4"],"parallel_with":["3.4b"],"status":"mandatory_in_full_preprod | removable_in_ideation_factory","amendments":["real_files","game_derived_skin","two_pass_qa","structure_not_skin","design_bar","examples_as_illustration"]}'::jsonb
)
ON CONFLICT (node_key) DO UPDATE SET
  title=EXCLUDED.title, phase=EXCLUDED.phase, role=EXCLUDED.role, status=EXCLUDED.status,
  purpose=EXCLUDED.purpose, standalone_prompt=EXCLUDED.standalone_prompt, default_prompt=EXCLUDED.default_prompt,
...
VALUES (
  ...
  '{"preview":true,"dna_version":"2.5.2","node_type":"LLM","sub_phase":"A_design","group":"A3","depends_on":["3.2","3.3","3.5","3.4b"],"parallel_with":[],"status":"mandatory_in_full_preprod | removable_in_ideation_factory","amendments":["real_files","game_derived_skin","two_pass_qa","structure_not_skin","design_bar","examples_as_illustration"]}'::jsonb
)
ON CONFLICT (node_key) DO UPDATE SET
  title=EXCLUDED.title, phase=EXCLUDED.phase, role=EXCLUDED.role, status=EXCLUDED.status,
  purpose=EXCLUDED.purpose, standalone_prompt=EXCLUDED.standalone_prompt, default_prompt=EXCLUDED.default_prompt,
